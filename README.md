...
- The admin password lives near the top of the `<script>` in `admin.html` — it's a soft lock, not real security, since this is all client-side. Nothing sensitive lives behind it.
